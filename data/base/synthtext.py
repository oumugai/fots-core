...
#add_data = ['“', '杭', '倖', '‘', '嶋', '庄', '翔', '鞠', '也', '揉', '蒼', '豹', '李', '絆', '與', 'ヴ', '叩', '儘', '穢', '嘘', '宏', '淳', '萌', '蘭', '呟', '정', '!', '煽', '來', '噂', '醤', '槻', '祐', '紗', '稀', '김', '繋', '頬', '�', '萩', '哉', '綴', '일', '♪', '"', '咎', '漣', '貰', '柴', '芦', '辻', 'ω', '誹', '鱗', '怯', '實', '○', '謗', '敦', '柏', '′', ' 蓮', '伊', '智', '朋', '蠣', '莉', '−', '々', '→', '棲', '裳', '舫', '烏', '濡', '%', '牡', '捏', '彦', '遼', '@', '儲', '麿', '澤', '磯', '罠', '玲', '兒', '—', '乃', '★', '國', '訝', '凜', '媚']
add_data = []
